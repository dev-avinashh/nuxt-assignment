<template>
  <div
    class="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 px-6 py-12"
  >
    <div
      class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 transition"
    >
      ...
      <div
        class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm text-gray-600 mb-6"
      >
